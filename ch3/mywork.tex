\chapter{Approach}\label{ch:approaches}
...
\begin{tabular}[c]{@{}l@{}}Syscall Library\\ API emulation\end{tabular} &
  Intermediate &
  \begin{tabular}[c]{@{}l@{}}Good, as the \\ solution is ISA \\ potable\end{tabular} &
  No &
  \begin{tabular}[c]{@{}l@{}}Can use native \\ Linux debugging \\ tools\end{tabular} &
  First \\
\begin{tabular}[c]{@{}l@{}}Kernel ABI \\ emulation\end{tabular} &
  Hard &
  \begin{tabular}[c]{@{}l@{}}Not as good as\\ the API layer\\ emulation\end{tabular} &
  Yes &
...
(TODO: why ABI emulation approach is ISA independent, It is not as the ELF file will be different, in this project targeting to x86)